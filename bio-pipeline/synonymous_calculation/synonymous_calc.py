...
CLUSTALW_BIN = "/usr/local/bioinfo/clustalw/2.1/bin/clustalw2"
PAL2NAL_BIN = "/usr/local/bioinfo/pal2nal/v14/pal2nal.pl"
PAML_BIN = "/usr/local/bioinfo/paml/4.4/bin/yn00"
##################################################
