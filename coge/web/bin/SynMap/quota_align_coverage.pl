...
use lib'/homedir/lariviere/perl5/lib/perl5';
use lib'/homedir/lariviere/perl5/lib/perl5/DBIx/Class';
...
$QUOTA_ALIGN = "/usr/local/bioinfo/src/coge/web/bin/quota-alignment/quota_align.py";
$CLUSTER_UTILS = "/usr/local/bioinfo/src/coge/web/bin/quota-alignment/cluster_utils.py";
